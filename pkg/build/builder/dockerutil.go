...
func buildImage(client DockerClient, dir string, dockerfileName string, noCache bool, tag string, tar tar.Tar, pullAuth *docker.AuthConfigurations, forcePull bool) error {
